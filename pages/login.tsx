        ...
        <>
            ...
            <div className="flex justify-center items-center overflow-y-hidden">
                <div className='flex my-48'>
                    <div className='flex flex-col bg-neutral-800 px-5 py-8 max-w-96 rounded-l-md rounded-r-md lg:rounded-r-none'>
                        <h1 className='text-3xl md:text-4xl lg:text-5xl font-bold text-center mb-8'>Login</h1>
                        <TextInput label='Username' username={username} setUsername={setUsername} />
                    ...
                    <div className='flex-col hidden lg:flex bg-neutral-800 px-5 py-8 max-w-96 rounded-r-md border-l-2 border-neutral-700'>
                        <Link href="/" className="mr-5">
                            <Image src={Logo} alt="TMDB" width={200} height={100} priority />
                        </Link>
                        <h2 className='text-2xl mt-8 font-semibold flex items-center'><RiQuestionFill className='mr-2' />Why should I login ?</h2>
                        <ul>
                            {
                        ...
                        <div className='mt-8'>
                            <h2 className='text-2xl mb-4 flex items-center font-semibold'><RiErrorWarningFill className='mr-2' />Warning</h2>
                            <p>This is not the official TMDB web site.</p>
                            <p>We using <Link className='text-sky-300' href="https://www.themoviedb.org/documentation/api" rel='noreferrer'>TMDB API</Link> just for fun.</p>
                        </div>
                    </div>
                </div>
                <ToastContainer />
